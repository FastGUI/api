...
var c = "%c 【大图模板】原创优质苹果cms模板，网址：www.datll.com";
      console.log(c, "background: rgb(247 1 186);background: -webkit-gradient(linear, left top, right top, color-stop(30%, rgba(177,0,247,1)), to(rgba(245,22,52,1)));background: -o-linear-gradient(left, rgba(177,0,247,1) 30%, rgba(245,22,52,1) 100%);background: linear-gradient(to right, rgba(177,0,247,1) 30%, rgba(245,22,52,1) 100%);font-size: 20px;");
